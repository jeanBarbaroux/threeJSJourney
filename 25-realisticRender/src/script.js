...
directionalLight.position.set(-7.9, 8, 4.6)
directionalLight.target.position.set(0, 4, 0)
directionalLight.target.updateWorldMatrix()
directionalLight.shadow.mapSize.set(1024, 1024)
scene.add(directionalLight)

gui.add(directionalLight, 'intensity').min(0).max(60).step(1).name('lightIntensity')
gui.add(directionalLight.position, 'x').min(-10).max(10).step(0.1).name('lightX')
gui.add(directionalLight.position, 'y').min(-10).max(10).step(0.1).name('lightY')
gui.add(directionalLight.position, 'z').min(-10).max(10).step(0.1).name('lightZ')
